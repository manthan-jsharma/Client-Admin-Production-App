          ...
          {statCards.map((stat) => (
            ...
            >
              <div
                ...
                style={{
                  background: "linear-gradient(90deg, #3A8DDE, #52b7f4)",
                }}
              />
              <div className="flex items-start justify-between mb-4">
                <div
                  className="w-10 h-10 rounded-xl flex items-center justify-center"
                  style={iconBoxStyles[stat.color]}
                >
              ...
              <div
                ...
                style={{ color: valueColors[stat.color] }}
              >
              ...
              <div className="text-xs" style={{ color: "#5F6B76" }}>
                {stat.sub}
              </div>
            </div>
          ))}
        ...
        <div className="overflow-hidden" style={CARD}>
          ...
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              {/* Using a simple fallback if EmptyState is specifically tied to payments logic, 
                  but the standard EmptyState component should work fine here as well */}
